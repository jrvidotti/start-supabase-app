...
import { isGoogleOAuthEnabled, isAzureOAuthEnabled } from "~/utils/auth";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          {(isGoogleOAuthEnabled() || isAzureOAuthEnabled()) &&
            (onGoogleAuth || onAzureAuth) && (
